...
import { sortArrayReviews } from './filterArray'


const OrgReview = ({ selectedItem }) => {
    ...
    const getReviews = () => {
        console.log('selectedItem?.item?._id', selectedItem?.item?._id)
        setLoader(true)
        ...
        fetch(API_Routes.EVENTSREVIEWS + selectedItem?.item?._id, requestOptions)
    ...
    const UpdateReviewsData = (item, data, action) => {
        ...
        fetch(API_Routes.UPDATEEVENTSREVIEWS, requestOptions)
            .then(response => response.json())
            .then(result => {
    ...
    return (
        <div>
            ...
            <div id='aboutEvent' className="orgEventMain myEventsCard">
                <div className='AboutEvent'>
                    <div style={{ marginBottom: 15 }} className="row goalTaskHeader col-md-12 align-items-center ">
                        <h2 className="col-md-2 mb-0 p-0 w-auto">Reviews </h2>
                    ...
                    {allReviews?.length ?
                                ...
                                <div className="col-md-12 mt-2">
                                                    ...
                                                    {!item.reply ?
                                                        ...
                                                        <div className='ReplyMain'>
                                                            <div style={{ width: '100%', cursor: 'pointer' }} onClick={() => setShowReply(index === showReply ? null : index)} >
                                                                <h6 className='showOrgReviewReply'>{index === showReply ? "Hide" : "Show"} Reply</h6>
                                                            </div>
                                                            {showReply === index && (
                                    ...
                                    {displayedReviews < data?.length && (
                                        <div className='text-center mt-4 py-4'>
                                            ...
                                            >
                                                <h6 className='LoadmoreeventsFeedback'>Load more reviews</h6>
                                                <img
                        ...
                        :
                        <div className='MediaEdit col-md-7  mt-5 d-flex align-items-center justify-content-center '>
                            <h4>No Review Found</h4>
                        </div>}
                </div>
            </div>
